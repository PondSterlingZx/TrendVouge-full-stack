...
import productModel from '../models/productModel.js';  // Assuming you have this model
import notifyModel from '../models/notifyModel.js';    // Assuming you have the notify model
...
// Export Controllers
export { sendNotifyEmails, addNotify };
